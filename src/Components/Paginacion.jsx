  ...
  return (
    <div className="flex items-center justify-center py-10 lg:px-0 sm:px-6 px-4">
      <div className="lg:w-3/5 w-full  flex items-center justify-between border-t border-gray-200">
        <button
          className={
            "flex items-center pt-3 text-white  hover:text-black cursor-pointer ${...currentPage <= 1 ? 'invisible'' : ' '}"
          }
          onClick={onPrevPage}
        >
          <svg
          ...
          <p className="text-sm ml-3 font-medium leading-none text-white hover:text-black ">
            Anterior
          </p>
        </button>
        ...
        <button
          className={
            "flex items-center pt-3 text-white hover:text-black  cursor-pointer ${ currentPage >= pageNumbers.length ? 'hidden' : ''}"
          }
          onClick={onNextPage}
        >
