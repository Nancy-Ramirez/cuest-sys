    ...
    return (
        <main>
          ...
          <section class="relative overflow-x-auto shadow-md sm:rounded-lg p-25">
            <h1 class="p-5 text-center text-3xl text-white">INSTITUCIONES</h1>
              ...
              <div class="flex items-center justify-between pb-4  m-2">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    class="block p-2 pl-10 text-sm text-black border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
